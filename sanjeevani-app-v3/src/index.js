...
async function sendEmail(name, email, message) {
  const msg = {
    ...
    from: {
      email: process.env.EMAIL_USER, // verified sender
      name: 'Sanjeevani Contact Form', // this is what shows in inbox
    },
  ...
  <div style="font-family: Arial, sans-serif; line-height:1.6; color:#333;">
    <div style="max-width:600px; margin:0 auto; padding:20px; border:1px solid #e0e0e0; border-radius:8px; background-color:#f9f9f9;">
      ...
      <h2 style="color:#10B981; text-align:center;">New Contact Form Submission</h2>
      ...
      <p style="margin-top:20px; color:#777; font-size:12px; text-align:center;">
        This email was sent from the Sanjeevani Contact Form.
      </p>
    </div>
  </div>
`,
