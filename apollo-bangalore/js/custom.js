// document.getElementById('Oncology').style.display = 'block'
...
//     console.log('evt.currentTarget', evt.currentTarget.className, tabLink)
//     history.pushState(null, null, '#' + tabLinks)
//   } else {
//     // If not triggered by event, set 'active' class via data attribute
//     for (i = 0; i < tablinks.length; i++) {
//       if (tablinks[i].getAttribute('data-city') === tabLinks) {
...
//   const actives = window.location.hash
